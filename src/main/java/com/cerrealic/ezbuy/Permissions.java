...
public final class Permissions {
	...
	public static final String COMMAND_COST_INCREASE = "ezbuy.command.ezbuy.costincrease";
	public static final String COMMAND_UPDATE_CHECKING = "ezbuy.command.ezbuy.updatechecking";
}
